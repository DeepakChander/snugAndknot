...
export default function WomenShopPage() {
  ...
  const womenProducts = useMemo(() => {
    let products = getAllProducts().filter(p => p.gender === 'women')
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl text-charcoal mb-4">
            <TextReveal>Women's Collection</TextReveal>
          </h1>
          <FadeIn delay={0.2}>
            <p className="text-lg text-walnut max-w-2xl">
              Timeless elegance meets modern design. Explore our curated collection of premium women's fashion.
            </p>
          </FadeIn>
        </div>
        ...
        {/* Product Count */}
        <p className="text-sm text-earth mb-6">{womenProducts.length} products</p>
