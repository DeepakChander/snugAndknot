  ...
  return (
    <div className="pt-32 pb-20 bg-ivory min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="font-heading text-4xl sm:text-5xl text-burgundy mb-6">Care Instructions</h1>
        <div className="w-16 h-px bg-gold mb-8" />
        <p className="text-wine/80 leading-relaxed mb-8">
          Learn how to care for your Snug&amp;Knot garments to keep them looking their best.
        </p>
        <Link
          href="/"
