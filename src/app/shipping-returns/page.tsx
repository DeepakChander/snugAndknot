  ...
  return (
    <div className="pt-32 pb-20 bg-ivory min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="font-heading text-4xl sm:text-5xl text-burgundy mb-6">Shipping &amp; Returns</h1>
        <div className="w-16 h-px bg-gold mb-8" />
        <p className="text-wine/80 leading-relaxed mb-8">
          Details about our shipping policies and return process will be available here soon.
        </p>
        <Link
          href="/"
